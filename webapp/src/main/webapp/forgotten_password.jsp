...
<form action="<c:url value='/Forgotten' />" method="post" role="form">
    ...
    <div class="row">
        <div class="col-md-12">
            <p><b>1.</b> Tell us the email address you signed up with;</p>
    ...
    <div class="row">
        <div class="col-md-12">
            <p><b>2.</b> Give us a secret word to include in your password reset email so you know it's from us;</p>
            <div class="form-group">
    ...
    <div class="row">
        <div class="col-md-12">
            <p><b>3.</b> Hit the button below;</p>
            <button name="secret" class="btn btn-primary"/>Send me a password reset email</button>
        </div>
    </div>
